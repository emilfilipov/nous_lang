...
- `cargo run -p nous_cli -- run tests/fixtures/valid/run_inferred_let.nl`: run initializer-inferred local bindings through source validation, semantic inference, runtime execution, and stdout output.
