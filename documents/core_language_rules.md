...
The compiler, installer, tests, examples, CLI, diagnostics, generated project templates, and documentation must consistently use `.lby` unless the language specification is intentionally changed.
