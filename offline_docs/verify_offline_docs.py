...
REQUIRED_PHRASES = [
    ...
    "lullaby-windows-x64.zip.sha256",
    "install.cmd",
    "uninstall.cmd",
...
GENERATED_REQUIRED_PHRASES = REQUIRED_PHRASES + [
    ...
    "Source: <code>documents/language_surface.md</code>",
    "Source: <code>documents/diagnostic_registry.md</code>",
    "Source: <code>documents/release_notes.md</code>",
    "Source: <code>documents/roadmap.md</code>",
    "Executable Examples",
    ...
    "lullaby compile [--optimize none|constant-fold|dead-code|full]",
